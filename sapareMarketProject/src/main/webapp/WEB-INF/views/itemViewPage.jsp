					...
					<div class="ctg1-section">
						...
						<div class="ctg1-width">
							...
							<div class="ctg1-tle">
								<!-- 카테고리 옵션 -->
								<div class="ctg1-op">
									패션잡화 <img src="image/down.jpg" width=20px;
					...
					<div class="ctg2-section">
						...
						<div class="ctg2-width">
							...
							<div class="ctg2-tle">
								<!-- 카테고리 옵션 -->
								<div class="ctg2-op">
									여행용가방/소품 <img src="image/down.jpg" width=20px;
										height=15px; alt="카테고리 화살표 아이콘" />
									<!-- 카테고리 선택창 -->
					...
					<div class="ctg3-section">
						...
						<div class="ctg3-width">
							...
							<div class="ctg3-tle">
								<!-- 카테고리 옵션 -->
								<div class="ctg3-op">
									소프트캐리어 <img src="image/down.jpg" width=20px;
										height=15px; alt="카테고리 화살표 아이콘" />
									<!-- 카테고리 선택창 -->
							...
							<div class="show-info">
								...
								<div class="state-show-tle">
									...
									<div class="sa-co-date-de-tle">
										...
										<div class="sa-co-date-tle">
											<!-- 찜 틀 -->
											<div class="sa-tle">
												<img src="image/sa.png" width=16px;
													height=16px; alt="상품 상태 아이콘">
												<div class="sa-count">${list.itemWantCnt }</div>
											</div>
											<!-- 조회수 틀 -->
											<div class="co-tle">
											...
											<div class="date-tle">
												<img src="image/date.jpg" width=16px;
													height=16px; alt="상품 상태 아이콘">${list.itemUploadDate }
											</div>
										</div>
										<!-- 신고하기 버튼 -->
									...
									<div class="item-state-tle">
										...
										<div class="item-one-tle">
											...
											<!-- 상품 상태 -->
											<div class="item-st">${list.itemBigCat } / ${list.itemMidCat } / ${list.itemSmallCat }</div>
										</div>
									</div>
								</div>
								<!-- 버튼 바 틀 -->
								<div class="bt-bar-tle">
									...
									<div class="bt-tle">
										<!-- 버튼 -->
										<button class="bt">
											<img src="image/sa.png" width="18" height="18"
												alt="찜 아이콘"> <span>찜</span> <span>${list.itemWantCnt }</span>
										</button>
										<!-- 버튼 취소 -->
										<div class="cancle-bt">
											<img src="image/declaration.png" width="16"
