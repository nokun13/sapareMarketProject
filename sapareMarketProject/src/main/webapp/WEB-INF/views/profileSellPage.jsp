				...
				<div class="menuAndContentArea">
					...
					<div class="profileContent">
						...
						<div class="contents">
							...
							<!--<c:forEach items="${sellItemList}" var="dto"> -->
							<!-- </c:forEach> -->
							
								<div class="reviewBox${dto.reviewNo }">
									<div class="buyerImgBox">
										<a href="#"><img class="buyerImg" src="/sapareMarket/images/${dto.profileImg }"></a>
									</div>
									<div class="buyerReviewBox">
										<div class="buyerName" style="margin-top:10px; font-weight:bold; overflow: hidden; margin-left: 5px; height: 19%; text-overflow: ellipsis;white-space: nowrap;">${dto.memberName }구매자 닉네임</div>
